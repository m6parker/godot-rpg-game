...
#check which slot type / station the player is trying to interact with
...
func _can_drop_data(_at_position: Vector2, data: Variant) -> bool:
	# dont let the player add items to the yeild slots
