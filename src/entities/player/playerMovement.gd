...
@onready var notification_scene = preload("res://src/ui/skill_notification.tscn")
@onready var craft_station_scene = preload("res://src/ui/menus/crafting_menu.tscn")
@onready var brewing_station_scene = preload("res://src/ui/menus/brewing_menu.tscn")
